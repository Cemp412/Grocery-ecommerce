	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			...
			<div class="agileinfo_single">
				<h5>Product Name: {{$ProductDetails->name}}</h5>
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="{{asset('/uploads/products/image/'.$ProductDetails->image)}}" alt=" " class="img-responsive" />
				</div>
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4>Price: Rs{{$ProductDetails->price}}<span> Old Price: {{$ProductDetails->old_price}}</span></h4>
						</div>
